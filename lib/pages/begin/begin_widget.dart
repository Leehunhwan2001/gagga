...
class _BeginWidgetState extends State<BeginWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BeginModel());
  }
